...
// Extend MeshLine agar bisa dipakai di JSX
extend({ MeshLineGeometry, MeshLineMaterial });

// Ganti path ini jika aset Anda ada di folder lain
// Gunakan "/portofolio/public/..." jika dideploy ke subfolder GitHub Pages
// Atau gunakan "/public/..." jika di root domain
const cardGLB = "./public/card.glb";
const lanyardImg = "./public/lanyard.png";
...
function Band({ maxSpeed = 50, minSpeed = 0 }) {
  ...
  // Load public (Pastikan file ada di public/public/)
  // Jika error "Could not load...", cek path file Anda
